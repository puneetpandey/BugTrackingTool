...
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('1', '1', 'manager', #{true}, '#{(Time.now - 5.years).to_s(:db)}', '#{(Time.now + 5.years).to_s(:db)}', '#{Time.now}', '#{Time.now}')"
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('4', '1', 'lead', #{true}, '#{(Time.now - 5.years).to_s(:db)}', '#{(Time.now + 5.years).to_s(:db)}', '#{Time.now}', '#{Time.now}')"
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('5', '1', 'lead', #{true}, '#{(Time.now - 5.years).to_s(:db)}', '#{(Time.now + 5.years).to_s(:db)}', '#{Time.now}', '#{Time.now}')"
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('6', '1', 'lead', #{true}, '#{Time.now - 5.years}', '#{Time.now + 5.years}', '#{Time.now}', '#{Time.now}')"

#Inserting data for:   Steve ---- Google, Charles---- Google,  Tim    ---- Google
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('2', '2', 'manager', #{true}, '#{Time.now - 4.years}', '#{Time.now + 5.years}', '#{Time.now}', '#{Time.now}')"
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('7', '2', 'lead', #{true}, '#{Time.now - 4.years}', '#{Time.now + 5.years}', '#{Time.now}', '#{Time.now}')"
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('8', '2', 'lead', #{true}, '#{Time.now - 4.years}', '#{Time.now + 5.years}', '#{Time.now}', '#{Time.now}')"

#Inserting data for:   Mark  ---- Oracle, De    ---- Oracle, Shane---- Oracle
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('3', '3', 'manager', #{true}, '#{Time.now - 3.years}', '#{Time.now + 5.years}', '#{Time.now}', '#{Time.now}')"
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('9', '3', 'lead', #{true}, '#{Time.now - 3.years}', '#{Time.now + 5.years}', '#{Time.now}', '#{Time.now}')"
ActiveRecord::Base.connection.execute "INSERT INTO project_memberships (user_id, project_id, role, is_active, billable_from, billable_to, created_at, updated_at) VALUES('10', '3', 'lead', #{true}, '#{Time.now - 3.years}', '#{Time.now + 5.years}', '#{Time.now}', '#{Time.now}')"
